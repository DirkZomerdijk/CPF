function oPrice = FTCS(X,S0,r,sig,Svec,tvec)
...
N=length(Svec); % Number of share price points
Smax=Svec(end); % Maximum share price considered
Smin=Svec(1); % Minimum share price considered
